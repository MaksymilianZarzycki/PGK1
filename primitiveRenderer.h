...
public:
    ...
    void drawCircle(float x, float y, float r, ALLEGRO_COLOR color);
    void drawEllipse(float x, float y, float rx, float ry, ALLEGRO_COLOR color);
    void drawPolygon(std::vector<Point2D>& points, ALLEGRO_COLOR color);
};